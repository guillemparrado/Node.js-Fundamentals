...
describe(`Promises & Callbacks - Nivell 2 Exercici 3`, () => {
    test(`getEmployeeAndSalary`, async () => {
        ...
        // Hi ha un problema fent-ho així, i és que l'execució de les crides és assíncrona i cal esperar a que acabin. Si poso el require i tot seguit l'expect, no li dona temps a log a haver estat cridat amb el missatge i el test falla. Si el poso abans d'iniciar el describe sí que li dona temps però és hacky, si alguna promesa tardés més el test no passaria, si estigués al límit a vegades passaria i a vegades no.
